...
2. Выполните скрипт `supabase_settings.sql` — таблицы `clients` (база клиентов) и `task_types` (типы задач для выпадающих списков на главной и на странице «Настройки»).
